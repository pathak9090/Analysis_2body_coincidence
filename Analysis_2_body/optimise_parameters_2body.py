...
import tkinter
from useful_definitions_2body import fhist1d,fhist2d
#
...
#        self.x=x
#        self.y=y
        pos_offset_1x,pos_offset_1y,pos_offset_2x,pos_offset_2y,t0=param_list
        ...
        self.ax1 = plt.subplot2grid((3,3),(0,0), fig=self.fig)
        self.ax2 = plt.subplot2grid((3,3),(0,1), fig=self.fig)
        self.ax3 = plt.subplot2grid((3,3),(0,2), fig=self.fig)
        self.ax4 = plt.subplot2grid((3,3),(1,0), fig=self.fig)
        self.ax5 = plt.subplot2grid((3,3),(1,1), fig=self.fig)
        self.ax6 = plt.subplot2grid((3,3),(1,2), fig=self.fig)
        self.ax7 = plt.subplot2grid((3,3),(2,0), fig=self.fig)
        self.ax8 = plt.subplot2grid((3,3),(2,1), fig=self.fig)
        self.ax9 = plt.subplot2grid((3,3),(2,2), fig=self.fig)
...
#        y=self.y
        ...
        self.param_list=[pos_offset_1x,pos_offset_1y,pos_offset_2x,pos_offset_2y,t0]

        mx1,cx1,mz1,cz1,mx2,cx2,mz2,cz2=self.vel_calc_fact
        ion1xgc,ion1ygc,ion1tgc,ion2xgc,ion2ygc,ion2tgc=self.xyt_array
        m1,m2=self.mass
